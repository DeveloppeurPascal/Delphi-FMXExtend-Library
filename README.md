...
Ouvrez le package situé dans le dossier "packages/VersionDeDelphi", compilez le puis installez le.

Vous pouvez ensuite tester les projets de démo situés dans le dossier "samples".
